...
const sourceOpenId =  tool.getValue('sourceOpenId');
const scope = sourceOpenId ? 'snsapi_base' : 'snsapi_userinfo';
const code =  tool.getValue('code');
const appid = 'wx8f145bc5c567af83';
const secret = 'c3c8f690e6904d83fa5de7ac9eb381ff';


code ? getInfo(code) : weiChatLogin(uri,state);


function weiChatLogin(uri,state){
...
function getInfo(code){
    let obj = {props:{source:'/doAction/userInfo'}};
    Post(obj,JSON.stringify({head:{webType:'wx',openid:''},body:{appid:appid,code:code,secret:secret}}),
        (result)=>{
